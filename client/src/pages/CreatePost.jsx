...
const CreatePost = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    if(form.prompt && form.photo){
      ...
      try {
        const response=await fetch('https://localohost:8080/api/v1/post',{
          method: 'POST',
          headers: {
            'Content-Type' : application/json,
          },
  ...
  return (
    <section className='max-w-7xl mx-auto'>
     <div>
        ...
        [500px]'>Create  imaginative and visually 
        stunning images through DALL-E AI and share them 
      ...
      <form className='mt-16 max-w-3xl' onSubmit={handleSubmit}>
        <div className='flex flex-col gap-5'>
          ...
          items-center'>
            ...
            {generatingImg && (
              ...
              center items-center bg-[rgba(0,0,0,0.5)] rounded-lg'>
                <Loader />
              </div>
            )}
          </div>
        ...
        <div className='mt-10'> 
            ...
            rounded-medium rounded-md text-sm w-full sm:w-auto px-5
            py-2.5 text-center'>
